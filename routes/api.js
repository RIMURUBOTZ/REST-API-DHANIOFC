...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('Selamat Datang DiRest Api DhaniOfc') // boleh diubah
}
...
var creator = 'DhaniOfc' // ubah jadi nama lu
const listkey = ["DhaniChan","DhaniOfc"]; // ubah apikey nya, tambah aja klo mau
